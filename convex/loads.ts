  ...
  handler: async (ctx) => {
    ...
    const sampleLoads: Array<Omit<Doc<"loads">, "_id" | "_creationTime">> = [
      ...
      },
      {
        ...
        pickup_datetime: new Date("2024-02-24T08:00:00.000Z").getTime(),
        delivery_datetime: new Date("2024-02-25T14:00:00.000Z").getTime(),
        equipment_type: "dry_van",
      ...
      },
      {
        ...
        pickup_datetime: new Date("2024-02-25T09:00:00.000Z").getTime(),
        delivery_datetime: new Date("2024-02-25T17:00:00.000Z").getTime(),
        equipment_type: "dry_van",
